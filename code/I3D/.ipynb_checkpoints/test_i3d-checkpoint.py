...
def run(init_lr=0.1,
        ...
        mode='rgb',
        root='WLASL/videos',
        train_split='WLASL/nslt_leaveout_user11_updated.json',
        batch_size=3 * 15,
        save_model='checkpoints/',
        weights='checkpoints/nslt_10_011000_0.860000.pt'):
    # setup dataset
    ...
    print(f"Total inference time: {hrs}h {mins}m {secs}s")
...
if __name__ == '__main__':
    ...
    train_split = 'WLASL/nslt_leaveout_user11_updated.json'.format(num_classes)
    weights = 'checkpoints/nslt_10_011000_0.860000.pt'
